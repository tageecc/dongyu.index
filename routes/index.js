...
//首页栏目名
var colunm_name = [['gsjj', 'zzjg', 'gsry', 'gsys'], ['gsxw'], ['yszp', 'yrdy', 'ychhd','spzb'], ['mxjj', 'bqhz', 'ggdl', 'ggzr'], ['lxfs', 'rczp', 'xmtg']];
var colunm_name_zh = [['公司简介', '组织架构', '公司荣誉', '公司优势'], ['公司新闻'], ['影视作品', '艺人代言', '演唱会、活动','视频直播'], ['明星经纪', '版权合作', '广告代理', '广告植入'], ['联系方式', '人才招聘', '项目投稿']];
